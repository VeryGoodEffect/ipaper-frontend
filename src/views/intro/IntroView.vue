<template>
  ...
  <header>
    ...
    <section>
      ...
      <button class="basic-btn-outline">{{ $t('register') }}</button>
  ...
  <main>
    <div>
      ...
      <div class="huge-input-wrapper">
        <input class="basic-input huge-input" type="text" placeholder="文献、期刊、作者以及更多" v-model="searchKeyword"
          @keyup.enter="basicSearch" />
        <svg @click="basicSearch" t="1699356103686" class="icon" viewBox="0 0 1024 1024" version="1.1"
          xmlns="http://www.w3.org/2000/svg" p-id="4162" width="200" height="200">
          <path
