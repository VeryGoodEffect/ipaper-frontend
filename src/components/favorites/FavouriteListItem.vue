<template>
    <div :class="[{'favorites-main-part': !isRenaming, 'favorites-main-part wider-card': isRenaming}]" @contextmenu.prevent="handleRightClick">
      ...
      <div class="renaming-block" v-else> 
        <input type="text" ref="nameInput" v-model="favourites.name" class="name-input">
        <svg @click="updateRenaming"
